    ...
    >
            ...
            >
              ...
              <div
                style={{
                  ...
                  color: hov === i ? "rgba(255,255,255,0.4)" : "#9ca3af",
                  marginBottom: 14,
                  fontWeight: 600,
                  transition: "color 0.35s ease",
                }}
              ...
              <p
                style={{
                  fontSize: 13,
                  lineHeight: 1.65,
                  color: hov === i ? "rgba(255,255,255,0.45)" : "#9ca3af",
                  transition: "color 0.35s ease",
                }}
              >
                {s.sub}
      ...
      >
        <div className="flex flex-col lg:flex-row" style={{ minHeight: 240 }}>
          ...
          >
            <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 10, letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: 12 }}>
              Ready to invest?
            </p>
            <h3
              style={{
