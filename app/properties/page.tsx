...
type PropertyType = "Apartment" | "Villa" | "Townhouse" | "Penthouse" | "Studio";
...
const TYPES: PropertyType[] = ["Apartment", "Villa", "Townhouse", "Penthouse", "Studio"];
...
function filterButtonClass(isActive: boolean) {
  return `rounded-sm px-3 py-1.5 text-xs border transition-colors ${
    isActive
      ? "bg-white text-black border-black"
      : "bg-black text-white border-gray-700 hover:text-white hover:border-gray-500"
  }`;
}
    ...
    <div className="bg-[#f8f7f5] min-h-screen pt-24 pb-16 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6">
          <aside className={`bg-white border border-gray-200 p-5 h-fit lg:sticky lg:top-24 ${showFilters ? 'block' : 'hidden'} lg:block`}>
            <div className="mb-5">
